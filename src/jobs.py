...
async def send_weekly_update(context: ContextTypes.DEFAULT_TYPE) -> tuple[int, int]:
    """
    ...
    for user in users_with_birthday:
        try:
            ...
            await context.bot.send_photo(chat_id=user_id, photo=image_bytes, caption=caption)
